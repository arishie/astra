...
describe('Penetration Testing - Injection Attacks', () => {
    ...
    describe('LDAP Injection Prevention', () => {
        ...
        function buildLDAPQuery(username) {
    ...
    describe('Template Injection Prevention', () => {
        function containsTemplateInjection(input) {
            const patterns = [
                /\{\{.*\}\}/, // Mustache/Handlebars
...
describe('Penetration Testing - Authentication Bypass', () => {
    describe('JWT Algorithm Confusion Prevention', () => {
        function validateJWTAlgorithm(header) {
    ...
    describe('OAuth State Parameter Validation', () => {
        class OAuthStateManager {
            states = new Map();
            stateTTL = 10 * 60 * 1000; // 10 minutes
...
describe('Penetration Testing - Access Control', () => {
    describe('IDOR Prevention', () => {
        ...
        it('should allow owner to access their resource', () => {
            ...
            expect(result.data.data).toBe('User A secret');
        });
    ...
    describe('Privilege Escalation via Parameter Tampering', () => {
        ...
        function sanitizeUpdateRequest(request, isAdmin) {
            const sanitized = {};
    ...
    describe('Path Traversal in File Operations', () => {
        ...
        function securePath(basePath, requestedPath) {
...
describe('Penetration Testing - Information Disclosure', () => {
    describe('Error Message Sanitization', () => {
        class SafeError extends Error {
            userMessage;
            internalDetails;
            constructor(userMessage, internalDetails) {
                super(userMessage);
        ...
        it('should use safe error for known errors', () => {
            const error = new SafeError('Invalid credentials', 'User user@example.com attempted login with wrong password from IP 192.168.1.1');
            const response = handleError(error);
