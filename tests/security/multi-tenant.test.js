...
describe('Multi-Tenant Security', () => {
    ...
    describe('Table Name Sanitization', () => {
        ...
        it('should replace dangerous characters', () => {
            ...
            expect(getUserTableName('user/../../../etc/passwd')).toBe('memory_user_user__________etc_passwd');
        });
    ...
    describe('Authentication Enforcement', () => {
        ...
        function createSession(userId, authLevel) {
        ...
        function requireAuth(token, minLevel) {
        ...
        it('should reject requests without authentication', () => {
            ...
            expect(() => requireAuth('invalid-token', AUTH_LEVEL.BASIC)).toThrow('Authentication required');
        });
        ...
        it('should enforce auth level requirements', () => {
            ...
            expect(() => requireAuth(basicToken, AUTH_LEVEL.HIGH_SECURITY)).toThrow('Insufficient privileges');
        });
    ...
    describe('Platform Link Security', () => {
        const platformLinks = new Map(); // platform:senderId -> userId
        function linkPlatform(platform, senderId, userId) {
            // Validate inputs
        ...
        function getLinkedUser(platform, senderId) {
    ...
    describe('Privilege Escalation Prevention', () => {
        const users = new Map();
        function createUser(id, isAdmin) {
            users.set(id, { id, isAdmin });
        }
        function updateUserRole(actingUserId, targetUserId, makeAdmin) {
