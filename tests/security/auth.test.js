...
describe('JWT Security', () => {
    ...
    function createMockJWT(payload, secret, expiresIn = 3600) {
    ...
    it('should reject tampered tokens', () => {
        ...
        const parts = token.split('.');
        const tamperedPayload = Buffer.from(JSON.stringify({ sub: 'user123', role: 'admin', iat: Date.now() / 1000, exp: Date.now() / 1000 + 3600 })).toString('base64url');
