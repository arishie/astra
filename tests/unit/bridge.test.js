...
describe('Bridge Base Functionality', () => {
    ...
    describe('Message Handling', () => {
        ...
        it('should throw when sending without connection', async () => {
            await expect(bridge.sendMessage('recipient', 'message')).rejects.toThrow('Bridge not connected');
        });
...
describe('BridgeManager', () => {
    class MockBridgeManager {
        bridges = new Map();
        factories = new Map();
        registerFactory(platform, factory) {
            this.factories.set(platform, factory);
        }
        async connectUser(userId, platform, credentials) {
    ...
    describe('User Connection', () => {
        ...
        it('should throw for unregistered platform', async () => {
            await expect(manager.connectUser('user1', 'signal', {})).rejects.toThrow('No factory');
        });
    });
...
describe('WhatsApp Mode Selection', () => {
    ...
    function validateWhatsAppConfig(mode, credentials) {
