...
export class AstraServer {
    ...
    private orchestrator: MultiTenantOrchestrator;
    private memoryManager: LanceManager;
    ...
    private setupRoutes(): void {
        ...
        // OpenAPI JSON spec
        this.app.get('/api/v1/docs/openapi.json', (req: Request, res: Response) => {
...
<body>
    ...
    async start(): Promise<void> {
        try {
            ...
            setOrchestratorHandler(async (userId: string, message: string, context: any) => {
                ...
                const response = await userContext.modelRouter.generateResponse(
                    message,
                    memoryContext
                );
