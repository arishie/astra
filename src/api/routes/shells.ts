...
import type { ShellConfig } from '../../shells/index.js';
...
export function setShellManager(manager: ShellManager): void {
    shellManager = manager;
}

function getManager(): ShellManager {
    if (!shellManager) {
...
router.get('/templates', (req: Request, res: Response) => {
    ...
    if (category) {
        res.json(getTemplatesByCategory(category as any));
    } else {
 ...
 */
router.get('/templates/team/:type', (req: Request, res: Response) => {
    const type = req.params.type as 'coding' | 'research' | 'content' | 'automation';
...
router.post('/', async (req: Request, res: Response) => {
    try {
        const config: ShellConfig = req.body;
 ...
 */
router.post('/:id/tasks/:taskId/approve', (req: Request, res: Response) => {
    const manager = getManager();
 ...
 */
router.post('/:id/tasks/:taskId/reject', (req: Request, res: Response) => {
 ...
 */
router.get('/supervisor', (req: Request, res: Response) => {
    const manager = getManager();
 ...
 */
router.post('/resume-all', (req: Request, res: Response) => {
    const manager = getManager();
    manager.resumeAll();
