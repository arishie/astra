...
export const CoderShell: ShellTemplate = {
    id: 'template_coder',
    name: 'Coder',
...
export const CodeReviewerShell: ShellTemplate = {
...
export const DebuggerShell: ShellTemplate = {
...
export const ResearcherShell: ShellTemplate = {
...
export const DataAnalystShell: ShellTemplate = {
...
export const WriterShell: ShellTemplate = {
    id: 'template_writer',
    name: 'Writer',
...
export const TechnicalWriterShell: ShellTemplate = {
...
export const PlannerShell: ShellTemplate = {
    id: 'template_planner',
    name: 'Planner',
...
export const ArchitectShell: ShellTemplate = {
...
export const ExecutorShell: ShellTemplate = {
...
export const AutomatorShell: ShellTemplate = {
...
export const CommunicatorShell: ShellTemplate = {
...
export const SupervisorShell: ShellTemplate = {
...
export const QAShell: ShellTemplate = {
    id: 'template_qa',
    name: 'QA Tester',
...
export const AllTemplates: ShellTemplate[] = [
    // Coding
    CoderShell,
    CodeReviewerShell,
    DebuggerShell,
 ...
 * Get template by ID
 */
export function getTemplate(id: string): ShellTemplate | undefined {
 ...
 */
export function getTemplatesByCategory(category: ShellTemplate['category']): ShellTemplate[] {
 ...
 */
export function getSuggestedTeam(projectType: 'coding' | 'research' | 'content' | 'automation'): ShellTemplate[] {
    switch (projectType) {
        case 'coding':
