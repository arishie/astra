...
export class MidjourneyWorker {
    ...
    private galleryDir: string = 'astra_gallery';
    private mjBotId: string = '936929561302675456'; // Standard Midjourney Bot ID
    ...
    public async generate(prompt: string, channelId: string): Promise<string> {
     ...
     */
    public async handleMjResponse(content: string, attachments: any[], channelId: string) {
