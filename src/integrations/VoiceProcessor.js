...
export class VoiceProcessor extends EventEmitter {
     ...
     */
    async processVoiceMessage(voice) {
        try {
            // Step 1: Transcribe
     ...
     */
    async executeAction(userId, intent) {
        switch (intent.type) {
            case 'calendar':
    ...
    async handleCalendarAction(userId, intent) {
    ...
    async handleEmailAction(userId, intent) {
        const { entities, rawText } = intent;
    ...
    async handleReminderAction(userId, intent) {
        const { entities, rawText } = intent;
    ...
    async handleNoteAction(userId, intent) {
    ...
    async handleQuestion(userId, intent) {
        return {
            success: true,
    ...
    async handleTaskAction(userId, intent) {
        const { entities, rawText } = intent;
...
//# sourceMappingURL=VoiceProcessor.js.map