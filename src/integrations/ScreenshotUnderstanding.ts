...
export class ScreenshotUnderstanding extends EventEmitter {
     ...
     */
    public async analyze(screenshot: Screenshot): Promise<VisionResponse> {
...
Respond in JSON format:
{
  ...
  "suggestedActions": [{ "label": "...", "action": "...", "data": {...}, "priority": 1 }]
     ...
     */
    private generateResponse(analysis: VisionAnalysis): {
        message: string;
        actions: SuggestedAction[];
    } {
        ...
        switch (type) {
            ...
            case 'product':
                ...
                if (products.length > 0) {
                    ...
                    if (products[0].price) message += ` - ${products[0].price}`;
                    message += `\n`;
                }
                message += `\n${description}\n\n`;
     ...
     */
    private explainError(errorText: string): string {
